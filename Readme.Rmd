...
This repository contains the data and code for Schramm, Gitter, and Gregory, "Total Maximum Daily Loads and *Escherichia coli* trends in Texas freshwater streams." Manuscript is currently in submission.
...
Code and data are shared under the CC By 4.0 license. If you use the code or data, please cite this source per the DOI and the DOI of the paper (in submission).
